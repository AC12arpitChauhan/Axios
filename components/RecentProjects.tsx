...
/**
 * Card with a 3D flip animation on hover.
 *
 * Front face shows the event image, title, and summary.
 * Back face reveals detailed event information.
 */
      ...
      >
        ...
        >
          <div className="w-full h-full flex flex-col">
            ...
            <h2 className="font-bold lg:text-2xl md:text-xl text-base line-clamp-1 px-2">
              {item.title}
            </h2>
            <p
...
/**
 * Recent projects / events section with 3D flip cards showing
 * event details on the back face.
 */
