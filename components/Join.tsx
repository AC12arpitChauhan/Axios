...
/**
 * Join / recruitment section — outlines the 4-step application process
 * alongside a call-to-action.
 */
const Join = () => {
  return (
      ...
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
        ...
        <div className="lg:w-1/3">
          ...
          <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
            Axios is not just a club; it&apos;s a high-performance team. We
            recruit the most dedicated, passionate, and skilled developers. Use
            the button to start your journey.
          </p>
        ...
        <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-8">
          {RECRUITMENT_STEPS.map((step) => (
            ...
            >
              <span className="text-azure font-mono text-xl mb-4 block">
                {step.number}
              </span>
